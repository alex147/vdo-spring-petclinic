...
@NamedQueries({ @NamedQuery(name = "PetType.findPetTypes", query = "SELECT ptype FROM PetType ptype ORDER BY ptype.name", hints = { @QueryHint(name = "vdb.language", value = "JPA") }) })
